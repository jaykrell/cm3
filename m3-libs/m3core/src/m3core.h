...
typedef struct m3core_DatePosix_T m3core_DatePosix_T;

#endif

void
__cdecl
DatePosix__FromTime(double t, /*const*/ INTEGER* zone, m3core_DatePosix_T* date, TEXT unknown, TEXT gmt);

...
int
__cdecl
IPInternal__GetHostByName(const char* s, int* res);

int
__cdecl
IPInternal__GetCanonicalByName(const char* s, TEXT* text);

int
__cdecl
IPInternal__GetCanonicalByAddr(const int* addr, TEXT* result);

BOOL
__cdecl
IPInternal__GetHostAddr(int* address);

int
__cdecl
IPInternal__GetAddrInfo(IP__Endpoint** ep, const char* node, const char* port);
...
void
__cdecl
IPInternal__NewEndpoint4(IP__Endpoint** ep, int port, const in_addr* adr);

void
__cdecl
IPInternal__NewEndpoint6(IP__Endpoint** ep, int port, const in6_addr* adr);

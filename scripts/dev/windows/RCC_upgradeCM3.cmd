...
copy /y %_cm3_PkgTree%m3-sys\config\* %CM3_ROOT%\bin\config
...
copy /y %_cm3_PkgTree%m3-sys\config\cm3.cfg %CM3_ROOT%\bin\cm3.cfg
if errorlevel 1 echo ERROR:  Problem copying files. & (set _cm3_ExitCode=5) & goto END
...
for %%f in (%_cm3_PkgTree%m3-sys\config\*) do call :Zap %%f %CM3_ROOT%\bin
echo.
